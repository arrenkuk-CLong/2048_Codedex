...
Run the py file, Arrow Keys control


# How to play - Text version: 
Same rules as normal 2048, Run the py file, Enter "w", "a", "s", "d" in the terminal, enter "q" to quit the game. Win and lose conditions exist
